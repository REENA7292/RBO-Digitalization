...
//     // Fetch Unit 2 Data
//     axios.get("http://localhost:8000/api/unit2/users")
...
//           No. of Approved Roles: <span className="font-bold">
//             {getUniqueCount(unit1Data, "roleCode")}
//           </span>
//         </div>

//         {/* Approved Jobs */}
//         <div className="dashboard-card approved-jobs">
//           No. of Approved Jobs: <span className="font-bold">
//             {getUniqueCount(unit1Data, "jobCode")}
//           </span>
//         </div>

//         {/* Occupied Jobs */}
//         <div className="dashboard-card occupied-jobs">
//           No. of Occupied Jobs: <span className="font-bold">
//             {getCountByValue(unit1Data, "availability", "OCCUPIED")}
//           </span>
//         </div>

//         {/* Resigned Jobs */}
//         <div className="dashboard-card resigned-jobs">
//           No. of Resigned Jobs: <span className="font-bold">
//             {getCountByValue(unit1Data, "availability", "RESIGNED")}
//           </span>
//         </div>

//         {/* Hold Jobs */}
//         <div className="dashboard-card hold-jobs">
//           No. of Hold Jobs: <span className="font-bold">
//             {getCountByValue(unit1Data, "availability", "HOLD")}
//           </span>
//         </div>

//         {/* Vacant Jobs */}
//         <div className="dashboard-card vacant-jobs">
//           No. of Vacant Jobs: <span className="font-bold">
//             {getCountByValue(unit1Data, "availability", "VACANT")}
//           </span>
//         </div>
//       </div>
