...
const UpdateUser = () => {
  ...
  const inputHandler = (e) => {
    ...
    useEffect(() => {
    axios
      .get(`https://rbo-digitalization-1.onrender.com/api/user/${id}`)
      .then((response) => {
  ...
  const submitForm = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.put(`https://rbo-digitalization-1.onrender.com/api/update/user/${id}`, user);
  ...
  return (
    <div className="addUser">
      ...
      <form className="addUserForm" onSubmit={submitForm}>
        ...
        <div className="inputGroup">
          <label htmlFor="positionHoldData">Position Hold Date:</label>
          <input
            type="text"
            id="positionHoldDate"
